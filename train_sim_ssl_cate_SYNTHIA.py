...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = './data/syn_deeplab'
...
SNAPSHOT_DIR = './snapshots_ssl/SYN2Cityscapes-cate2ins'
WEIGHT_DECAY = 0.0005
LOG_DIR = './log'
SAVE_PATH = './result/cityscapes-SYN'
...
def main():
    ...
    for i_iter in range(Iter, args.num_steps):
        ...
        if i_iter >= args.num_steps_stop - 1:
            ...
            torch.save(model_D.state_dict(), osp.join(args.snapshot_dir, 'SYN_' + str(args.num_steps_stop) + '_D.pth'))
            break
        ...
        if i_iter % args.save_pred_every == 0 and i_iter != 0:
            ...
            if mIoU > bestIoU:
                bestIoU = mIoU
                torch.save(model.state_dict(), osp.join(args.snapshot_dir, 'BestSYN.pth'))
                torch.save(model_D.state_dict(), osp.join(args.snapshot_dir, 'BestSYN_D.pth'))
