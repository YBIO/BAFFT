...
SNAPSHOT_DIR = './snapshots_ssl/GTA2Cityscapes'
WEIGHT_DECAY = 0.0005
LOG_DIR = './log'
            ...
            if i_iter > 0:
                ...
                for ii in range(len(FG_LABEL)):
                    ...
                    for i in range(min(10, len(sortmax))):
                        ...
                        loss_ins += BETA* CATEGORY_INS_COFF[i] * torch.min(torch.sum(L1_loss(feature, src_ins_features[ii,:,:]),dim=1) / 2048.) / min(10, len(sortmax))
