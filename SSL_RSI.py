...
SAVE_PATH = './target_ssl_gt_MassRoad'

IGNORE_LABEL = 255
NUM_CLASSES = 2
RESTORE_FROM = './snapshots/MassRoad2DeepGlobe_deeplabv3+/Best.pth'
SET = 'train'
...
def main():
    ...
    predicted_label = np.zeros((len(trainset), 512, 512))
    predicted_prob = np.zeros((len(trainset), 512, 512))
    image_name = []
