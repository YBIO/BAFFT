...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = '/home/yb/dataset/MassBuilding2IAILD'
...
WEIGHT_DECAY = 0.0005
LOG_DIR = './log'
SAVE_PATH = './result/MassBuilding2Inria'
...
def main():
    ...
    # init data loader
    if args.data_dir.split('/')[-1] == 'IAILD':
        ...
        trainset = MassBuildingDataSet(args.data_dir, args.data_list,
                                       max_iters=args.num_steps * args.iter_size * args.batch_size,
                                       crop_size=input_size,
                                       scale=args.random_scale, mirror=args.random_mirror, mean=IMG_MEAN)
